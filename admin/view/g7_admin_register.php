        ...
        <main>
            ...
            <nav class="sidebar">
                <ul>
                    ...
                    <li><a href="merchandise_registration.php">管理者登録</a></li>
                </ul>
                            ...
                            <?php if (!empty($merchandises)): ?>
                                <?php foreach ($merchandises as $merchandise): ?>
                                    <tr>
                                        ...
                                        <td><a href="g5_item_update_view.php?<?= htmlspecialchars($merchandise['merchandise_id']); ?>"><?php echo htmlspecialchars($merchandise['merchandise_id']); ?></a></td>
